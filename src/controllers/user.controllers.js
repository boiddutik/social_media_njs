...
const createUser = asyncHandler(
    async (req, res) => {
        try {
            ...
            return res
                .status(201)
                .json(new ApiResponse(201, { user: userWithoutSensitiveData, }, "Account created successfully."));
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    return res
        ...
        .json(new ApiResponse(200, { user: loggedInUser, jwt: accessToken, rwt: refreshToken, profile: loggedInUserProfile, }, "User logged In Successfully."))
})
